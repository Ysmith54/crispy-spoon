...
import ApproveDenyComponent from "./approval.component";
import { Claim, claimStatus } from "./request";
import claimService from "./request.service";
import ExtraInformationComponent from "./moreInfo.component";
    ...
    return (
        <div>
            ...
            {claim.infoFrom === employee.username && claim.status === claimStatus.infoRequired ?
                ...
                : <></>}
            {canCancel &&
                <button className='btn btn-danger' onClick={deleteClaim}>Cancel Request</button>
            }
        </div>
    );
}
