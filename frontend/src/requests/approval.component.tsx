...
import { employeeRole } from "../user/employee";
...
function ApproveDenyComponent(props: ApproveDenyProps) {
    ...
    const changeReimbursement = () => {
        //BenCo/HR can change reimbursement
    ...
    return (
        <div>
            ...
            {employee.role === employeeRole.benCo &&
                <button className='btn btn-info' onClick={changeReimbursement}>Modify Reimbursement Request</button>
            }
            {requestingInfo &&
                <>
                    <br />
            ...
            {changingReimbursement && employee.role === employeeRole.benCo &&
                ...
                New reimbursement amount:
                    ...
                    {increasingReimbursement ?
                        <>
                            <p>Reason for reimbursement amount increase:</p>
                            <input type='text' className='form-control' onChange={handleFormInput} name='newReimbursementReason'></input>
                        </> : <></>}
                    <br />
                    <button className='btn btn-info' onClick={confirmChangeReimbursement}>Update Reimbursement Request</button>
                </>}
        </div>
    );
}
